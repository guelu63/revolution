...
$_lang['resource_alias_visible_help'] = 'El alias de este recurso se insertado en la ruta de alias de URL amigable';
...
$_lang['resource_err_symlink_target_invalid'] = 'El destino del enlace simbólico (symlink) no contiene un valor entero.';
$_lang['resource_err_symlink_target_nf'] = 'No puedes vincular a un recurso que no existe.';
$_lang['resource_err_symlink_target_self'] = 'No se puede vincular a sí mismo.';
...
$_lang['resource_err_weblink_target_nf'] = 'No puedes establecer un enlace web (weblink) a un recurso que no existe.';
$_lang['resource_err_weblink_target_self'] = 'No puedes establecer un enlace web a sí mismo.';
