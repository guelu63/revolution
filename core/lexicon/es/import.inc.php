...
$_lang['import_element_help'] = 'Proporciona  JSON con asociaciones "campo":"valor". Si el valor comienza con $, es un selector similar a jQuery. El campo puede ser un campo de Recursos o un nombre de VdP.';
