...
$_lang['tv_delete_confirm'] = '¿Estás seguro/a de que quieres eliminar esta VdP?';
...
$_lang['tv_desc_name'] = 'El nombre de esta VdP. Estará disponible usando la etiqueta [[*NombreDeVdP]].';
$_lang['tv_description'] = 'Descripción';
$_lang['tv_err_delete'] = 'Se produjo un error al eliminar la variable de plantilla.';
$_lang['tv_err_duplicate'] = 'Se produjo un error al intentar duplicar la variable de plantilla.';
...
$_lang['tv_err_save_access_permissions'] = 'Se produjo un error al intentar guardar los permisos de acceso de la variable de plantilla.';
$_lang['tv_err_save'] = 'Se produjo un error al guardar la variable de plantilla.';
...
$_lang['tv_inuse_template'] = 'Las siguientes plantillas están utilizando esta VdP actualmente: [[+templates]]. <br /> <br /> Desvincula la VdP de las plantillas antes de eliminarla.';
...
$_lang['tv_msg'] = 'Agrega o edita la Variable de plantilla aquí. Las variables de plantilla deben asignarse a plantillas para acceder a ellas desde snippets y documentos.';
...
$_lang['tv_tmpl_access_msg'] = 'Selecciona las plantillas que pueden acceder a esta variable de plantilla.';
$_lang['tv_widget'] = 'Widget';
$_lang['tv_widget_prop'] = 'Propiedades del Widget';
$_lang['tvd_err_remove'] = 'Se produjo un error al intentar eliminar la variable de plantilla del documento.';
$_lang['tvdg_err_remove'] = 'Se produjo un error al intentar eliminar la variable de plantilla del grupo de documentos.';
$_lang['tvdg_err_save'] = 'Se produjo un error al intentar vincular la variable de plantilla al grupo de documentos.';
$_lang['tvs'] = 'Variables de Plantilla';
$_lang['tvt_err_nf'] = 'La variable de plantilla no tiene acceso a la plantilla especificada.';
$_lang['tvt_err_remove'] = 'Se produjo un error al intentar eliminar la variable de plantilla de la plantilla.';
$_lang['tvt_err_save'] = 'Se produjo un error al intentar vincular la variable de plantilla a la plantilla.';
