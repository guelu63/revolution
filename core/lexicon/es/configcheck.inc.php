...
$_lang['configcheck_allowtagsinpost_context_enabled'] = 'La Configuración de Contexto "allow_tags_in_post" está activada fuera del Contexto "mgr"';
